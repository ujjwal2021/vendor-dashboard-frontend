...
const [warningActive, setWarningActive] = useState(false)
  ...
  console.log(singleBusTypeFetch);
  ...
  return (
    <div className="outer-cover">
      ...
      <Warning isActive={warningActive} tagline="Bus type will be permanently deleted." continueClick={handleDeleteBusTypes} cancelClick={()=> setWarningActive(false)} isDisabled={deleteBusTypeLoading || deleteBusTypeSuccess}/>
